...
#    Updated: 2019/12/26 19:10:16 by fbouibao         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = c_hundler.c	ft_atoi.c	ft_get_spfr.c	ft_itoa.c	ft_itoa_long16.c	ft_memset.c	\
	...
	utils_nbrs.c	x_hundler.c	d_hundler.c	ft_get_ob.c	ft_isdigit.c	ft_itoa_16.c	\
	ft_printf.c	ft_strdup.c	ft_substr.c	fts_l_list.c	pct_hundler.c	u_hundler.c	utils_str.c	\
	cut_width.c	cut_prec.c	fct_aff.c	rmpl_node.c	free_prog.c	prec_d.c	prec_u.c	prec_x.c\
...
O = c_hundler.o	ft_atoi.o	ft_get_spfr.o	ft_itoa.o	ft_itoa_long16.o	ft_memset.o	\
	...
	d_hundler.o	ft_get_ob.o	ft_isdigit.o	ft_itoa_16.o	ft_printf.o	ft_strdup.o	\
	ft_substr.o	fts_l_list.o	pct_hundler.o	u_hundler.o	utils_str.o cut_width.o cut_prec.o fct_aff.o	\
	rmpl_node.o	free_prog.o	prec_d.o	prec_u.o	prec_x.o\
